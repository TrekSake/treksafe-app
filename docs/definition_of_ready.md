...
Completar antes de marcar `Dev Ready = Yes`. Cada HU debe documentar los nueve elementos **CONNEXTRA**: **C**omo, **N**ecesito, **P**ara, **E**ntidades, **R**estricciones, **N**egocio, **E**xcepciones, **T**amaño, **T**est.
...
**Como** senderista
**Necesito** marcar manualmente mi regreso exitoso antes de vencer el plazo
**Para** notificar que estoy a salvo y cerrar la expedición

**Entidades:** Expedition, User
**Restricciones:** SA-04
**Negocio:** Verificación positiva manual que detiene el monitoreo pasivo
**Excepciones:** Contraseña incorrecta en confirmación; check-in tras vencimiento sin tolerancia
**Tamaño:** 3 story points
**Test:** E2E check-in + estado completed + detención del temporizador
```
