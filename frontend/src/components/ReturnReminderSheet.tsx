...
import type { ActiveExpedition } from '@/services/expedition';
...
export function ReturnReminderSheet({ expedition, minutesRemaining, onDismiss, checkInHref }: Props) {
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      >
        ...
        <h2 id="return-reminder-title" className="text-xl font-bold mb-2 leading-tight">
          {minutesRemaining <= 30
            ? `Faltan ${minutesRemaining} minutos para tu límite`
        ...
        <div className="bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 rounded-2xl px-4 py-3 mb-5 flex items-center justify-between">
          <div>
            ...
            <p className="font-bold text-amber-700 dark:text-amber-300">
              {formatReturn(expedition.deadlineAt)}
            </p>
          </div>
